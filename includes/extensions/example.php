 ...
 * Example Extension.
 *
 * Class for adding a Example element to the Fusion Engine
 *
 * @since 1.0.0
 */
...
class FusionExample	{
	...
	public function __construct() {
		...
		//initialize example
		add_action('init', array($this, 'init_example'), 12);

		//add example shortcode
		add_shortcode('fsn_example', array($this, 'example_shortcode'));
  ...
  public function example_shortcode( $atts, $content ) {
    //note: usage of extract should be deprecated
